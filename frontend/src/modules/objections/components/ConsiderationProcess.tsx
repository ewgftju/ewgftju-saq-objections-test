...
const OBJECTION_STAGES: ProcessStage[] = [
  ...
  },
  {
    ...
    statuses: ["commission_members", "commission_voting", "circulated"],
  },
  {
    label: "Решение",
...
const TASK_HELP: Partial<Record<Action, string>> = {
  ...
  "review-commission-documents":
    "Ознакомьтесь со справкой и материалами обращения. После подтверждения откроется выбор участников заседания.",
  "choose-commission-members":
    "Выберите председательствующего и членов апелляционной комиссии, которые будут участвовать в заседании.",
  "commission-vote":
    "Выберите «За» или «Против» по каждому оспариваемому пункту и сохраните результаты голосования.",
  members:
