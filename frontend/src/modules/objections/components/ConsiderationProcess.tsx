...
const OBJECTION_STAGES: ProcessStage[] = [
  ...
  {
    label: "Материалы",
    description: "Позиция ДВГА и анализ доводов",
...
const CONTROL_STAGES: ProcessStage[] = [
  ...
  {
    label: "Материалы",
    description: "Передача и изучение дела",
...
const TASK_HELP: Partial<Record<Action, string>> = {
  ...
  request:
    "Составьте запрос в ДВГА о представлении позиции по оспариваемым пунктам. После сохранения запрос появится в материалах дела.",
  position:
    "Зарегистрируйте ответ ДВГА: позицию и обоснование по каждому оспариваемому пункту.",
  analysis:
    "Сопоставьте доводы объекта, доказательства и позицию ДВГА. Подготовьте обоснованный проект решения по каждому спорному пункту.",
  members:
